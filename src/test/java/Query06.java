...
public class Query06 {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        Connection con =  DriverManager.getConnection("jdbc:mysql://localhost:3306/batch59?serverTimezone=UTC", "root", "Murat34+");
        ...
        String[] veri2 = {"insert into values(81,'YEMEKHANE','ISTANBUL')",
                "insert into values(82,'OFIS1','ANKARA')",
                "insert into values(83,'OFIS2','TRABZON')"};
